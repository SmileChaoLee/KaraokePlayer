...
file(INSTALL DESTINATION "/usr/local/lib/pkgconfig" TYPE FILE FILES "/Users/chaolee/AndroidStudio/KaraokePlayer/extensions/av1/.cxx/cmake/release/armeabi-v7a/libgav1.pc")
endif()
...
file(INSTALL DESTINATION "/usr/local/share/cmake" TYPE FILE FILES "/Users/chaolee/AndroidStudio/KaraokePlayer/extensions/av1/.cxx/cmake/release/armeabi-v7a/libgav1-config.cmake")
endif()
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/Users/chaolee/AndroidStudio/KaraokePlayer/extensions/av1/.cxx/cmake/release/armeabi-v7a/libgav1/gav1_decode")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/gav1_decode" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/gav1_decode")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/Users/chaolee/Library/Android/sdk/ndk-bundle/toolchains/llvm/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-strip" "$ENV{DESTDIR}/usr/local/bin/gav1_decode")
    endif()
  endif()
endif()
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE STATIC_LIBRARY FILES "/Users/chaolee/AndroidStudio/KaraokePlayer/extensions/av1/.cxx/cmake/release/armeabi-v7a/libgav1/libgav1.a")
endif()
